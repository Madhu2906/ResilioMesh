...
Open pgAdmin and create a new database named resiliomesh_db.

Configure your database credentials inside resiliomesh-backend/resiliomesh-backend/src/main/resources/application.properties:
...
Admin Control Panel: http://localhost:8080/admin_dashboard.html

3. Mobile App Setup
Navigate to the Flutter project directory:
cd ResilioMesh

Configure your server IP address inside lib/config/api_config.dart:
